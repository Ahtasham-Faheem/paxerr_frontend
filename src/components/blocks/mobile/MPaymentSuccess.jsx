...
const MPaymentSuccess = ({ onShowSignIn, onShowSignUp, onBackToPayment }) => {
  return (
    <div className="relative w-full h-fit text-center lg:-mr-28 !pointer-events-auto">
      ...
      <div className="order-bg w-full h-full max-2xl:bg-[#17171791] backdrop-blur-xs py-13 lg:pt-12 2xl:pt-16 flex flex-col items-center justify-center">
        ...
        <div className="mt-4 flex gap-9">
          <Button onClick={onShowSignIn} className="mx-auto mb-4">
            SIGN IN
          </Button>
...
export default MPaymentSuccess;
